...
/**
 * Whether a user id is in the ADMIN_USER_IDS allowlist. Same source of truth as
 * requireAdmin, exposed so auth responses can surface an `isAdmin` flag to the
 * client. Fail-closed: unset env → false for everyone.
 */
